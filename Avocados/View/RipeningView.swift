...
//  Avocados
//
//  Created by Orlando Moraes Martins on 05/03/23.
//
    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .center, spacing: 10) {
                ...
                Text("Fresh of the tree, the avocado is very hard to give.")
                ...
                Text("5+ Days")
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 20)
                            ...
                            .shadow(color: Color("ColorBackTransparentLight"), radius: 6, x: 0, y: 6)
                    )
